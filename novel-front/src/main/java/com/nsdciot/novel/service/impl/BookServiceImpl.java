...
import com.nsdciot.novel.core.cache.CacheKey;
import com.nsdciot.novel.core.cache.CacheService;
import com.nsdciot.novel.core.config.BookPriceProperties;
import com.nsdciot.novel.core.enums.ResponseStatus;
import com.nsdciot.novel.entity.Author;
import com.nsdciot.novel.entity.BookAuthor;
import com.nsdciot.novel.entity.BookCategory;
...
import com.nsdciot.novel.mapper.BookAuthorDynamicSqlSupport;
import com.nsdciot.novel.mapper.BookAuthorMapper;
import com.nsdciot.novel.mapper.BookCategoryDynamicSqlSupport;
import com.nsdciot.novel.mapper.BookCategoryMapper;
import com.nsdciot.novel.mapper.BookCommentDynamicSqlSupport;
...
import com.nsdciot.novel.mapper.BookIndexMapper;
import com.nsdciot.novel.mapper.FrontBookCommentMapper;
import com.nsdciot.novel.mapper.FrontBookMapper;
import com.nsdciot.novel.mapper.FrontBookSettingMapper;
import io.github.xxyopen.web.util.BeanUtil;
import com.nsdciot.novel.core.utils.Constants;
import com.nsdciot.novel.core.utils.StringUtil;
...
import static com.nsdciot.novel.mapper.BookCategoryDynamicSqlSupport.bookCategory;
import static com.nsdciot.novel.mapper.BookCommentDynamicSqlSupport.bookComment;
import static com.nsdciot.novel.mapper.BookContentDynamicSqlSupport.bookContent;
import static com.nsdciot.novel.mapper.BookContentDynamicSqlSupport.content;
import static com.nsdciot.novel.mapper.BookDynamicSqlSupport.*;
import static com.nsdciot.novel.mapper.BookIndexDynamicSqlSupport.bookIndex;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> listClickRank(Integer pageSize) {
        List<Book> result = (List<Book>) cacheService.getObject(CacheKey.INDEX_CLICK_BANK_BOOK_KEY);
        if (result == null || result.size() == 0) {
            result = listRank((byte) 0, pageSize);
            cacheService.setObject(CacheKey.INDEX_CLICK_BANK_BOOK_KEY, result, 5000);
        }
        return result;
    }
