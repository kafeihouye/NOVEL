...
import com.nsdciot.novel.mapper.CrawlSingleTaskDynamicSqlSupport;
import com.nsdciot.novel.mapper.CrawlSingleTaskMapper;
import com.nsdciot.novel.mapper.CrawlSourceDynamicSqlSupport;
import com.nsdciot.novel.mapper.CrawlSourceMapper;
import com.nsdciot.novel.entity.CrawlSource;
import io.github.xxyopen.model.page.PageBean;
import com.nsdciot.novel.core.cache.CacheKey;
import com.nsdciot.novel.core.cache.CacheService;
import com.nsdciot.novel.core.crawl.CrawlParser;
import com.nsdciot.novel.core.crawl.RuleBean;
...
import com.nsdciot.novel.service.CrawlService;
import com.nsdciot.novel.vo.CrawlSingleTaskVO;
import com.nsdciot.novel.vo.CrawlSourceVO;
...
import static com.nsdciot.novel.core.utils.HttpUtil.getByHttpClientWithChrome;
...
public class CrawlServiceImpl implements CrawlService {
    ...
    public PageBean<CrawlSource> listCrawlByPage(int page, int pageSize) {
        ...
        SelectStatementProvider render = SelectDSL
            .select(CrawlSourceDynamicSqlSupport.id, CrawlSourceDynamicSqlSupport.sourceName, CrawlSourceDynamicSqlSupport.sourceStatus, CrawlSourceDynamicSqlSupport.createTime, CrawlSourceDynamicSqlSupport.updateTime)
                .from(CrawlSourceDynamicSqlSupport.crawlSource)
                .orderBy(CrawlSourceDynamicSqlSupport.updateTime)
                .build()
    ...
    public CrawlSource queryCrawlSource(Integer sourceId) {
        SelectStatementProvider render = select(CrawlSourceDynamicSqlSupport.sourceStatus, CrawlSourceDynamicSqlSupport.crawlRule)
                .from(CrawlSourceDynamicSqlSupport.crawlSource)
                .where(CrawlSourceDynamicSqlSupport.id, isEqualTo(sourceId))
                .build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    public PageBean<CrawlSingleTask> listCrawlSingleTaskByPage(int page, int pageSize) {
        PageHelper.startPage(page, pageSize);
        SelectStatementProvider render = SelectDSL.select(CrawlSingleTaskDynamicSqlSupport.crawlSingleTask.allColumns())
